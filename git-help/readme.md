...
to have **auto-save** selected in your editor.

- Check the
 
status of your files by running the following command:
...
commits from your **local** repository to your repository on
