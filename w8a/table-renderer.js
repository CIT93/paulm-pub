...
let currentConfirmingTimeoutID = null;
...
const showDeleteConfirmingButtons = function(actionCell, id, onDeleteCallback){
    ...
    currentConfirmingTimeoutID = setTimeout(function(){
...
export const resetRowConfirmationState = function(){
    if(currentConfirmingRowElement){
        if(currentConfirmingTimeoutID){
            clearTimeout(currentConfirmingTimeoutID);
            currentConfirmingTimeoutID = null;
        };
